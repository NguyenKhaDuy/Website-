...
<body class="animsition">
        ...
        <div class="page-container">
                            ...
                            <div class="col-md-12">
                                ...
                                switch ($page) {
                                    ...
                                    case "order":
                                        ...
                                        break;
                                    case "topping":
                                        require "page/topping.php";
                                        break;
                                    case "productTopping":
                                        require "page/productTopping.php";
                                        break;
                                    default:
                                        require "page/product.php";
                                }
            ...
            switch ($page) {
                ...
                case "order":
                    ...
                    break;
                case "category":
                    require "block/modalAddCase.php";
                    require "block/modalUpdateCase.php";
                    break;
                case "topping":
                    require "block/modalAddTopping.php";
                    require "block/modalUpdateTopping.php";
                    break;
                case "productTopping":
                    require "block/modalAddProductTopping.php";
                    require "block/modalUpdateProductTopping.php";
                    break;
                default:
                    require "block/modalAddProduct.php";
                    require "block/modalupdateProduct.php";
    ...
    <script src="js/topping.js"></script>
    <!-- Main JS-->
