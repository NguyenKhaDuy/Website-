...
$id = $_SESSION['idUser'];
$user = getUserByIdUser($id)->fetch_assoc();
?>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="profile-img">
                    <img src="public/<?php echo $user['img'] ?>" alt="" />
                    <div class="file btn btn-lg btn-primary" style="font-family: sans-serif;font-weight: 600" onclick="updateAvatar(<?php echo $user['id'] ?>)">
                        Đổi ảnh
