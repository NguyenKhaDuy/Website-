                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr id="tr<?php echo $cartKey ?>">
                                                ...
                                                <td class="product-quantity"><input class="form-control" style="width:80px" onclick="update_cart('<?php echo $cartKey ?>',this)" onchange="update_cart('<?php echo $cartKey ?>',this)" min=1 type="number" value="<?php echo $product['qty'] ?>" /></td>
