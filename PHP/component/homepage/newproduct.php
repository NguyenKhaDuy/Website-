                ...
                <div class="product__content content--center">
                    ...
                    <div class="product__hover--content">
                        <ul class="rating d-flex">
                            <?php
                            $sumEvaluate = getSumEvaluateProduct($row['id']);
                            $countUser = getCountUserEvaluate($row['id']);
                            $evaluate = ($countUser > 0) ? floor($sumEvaluate / $countUser) : 0;
                            for ($i = 1; $i <= 5; $i++):
                            ?>
                                <li class="<?= ($i <= $sumEvaluate) ? 'on' : ''; ?>">
