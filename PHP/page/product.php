                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="product__info__main">
                                ...
                                <div class="price-box">
                                    <span id="display-price"><?php echo number_format($info['price']) ?> VNĐ</span>
                                    <input type="hidden" id="base-price" value="<?php echo $info['price'] ?>"> <!-- lưu giá gốc sản phẩm -->
                                </div>
                                <div>
                                    <?php
                                ...
                                <div>
                                    <?php
                                    $sql = "SELECT t.idtopping, t.nametopping, t.pricetopping 
                                    FROM topping t
                                    INNER JOIN information_productstopping ips ON t.idtopping = ips.id_topping
                                    WHERE ips.id_product = $idProduct";
                                    $result = $conn->query($sql);

                                    if ($result && $result->num_rows > 0) {
                                        echo '<div>';
                                        echo '<label for="toppings" style="padding-top: 10px;">Chọn topping kèm:</label><br>';
                                        echo '<div class="toppings">';
                                        while ($row = $result->fetch_assoc()) {
                                            echo '<div class="topping-option">';
                                            echo '<input type="checkbox" 
                                                    id="topping' . $row["idtopping"] . '" 
                                                    name="topping[]" 
                                                    value="' . $row["idtopping"] . '" 
                    ...
                    <div class="tab__container">
                        ...
                        <div class="pro__tab_label tab-pane fade" id="nav-review" role="tabpanel">
                            ...
                            <div class="review-fieldset">
                                <h2 style="padding: 12px">Đánh giá của bạn:</h2>
                                <div class="review-field-ratings">
                                    <div class="product-review-table">
                                        <div class="review-field-rating d-flex">
                                            <!-- <span style="font-family: sans-serif;">Chất lượng</span> -->
                                            <ul style="padding: 12px; font-size: 30px" class="rating d-flex">
                                                <li class="star" data-value="1"><i class="zmdi zmdi-star"></i></li>
                                                <li class="star" data-value="2"><i class="zmdi zmdi-star"></i></li>
                                                <li class="star" data-value="3"><i class="zmdi zmdi-star"></i></li>
                                                <li class="star" data-value="4"><i class="zmdi zmdi-star"></i></li>
                                                <li class="star" data-value="5"><i class="zmdi zmdi-star"></i></li>
                                            </ul>
                                        </div>
                                        <!-- <div class="review-field-rating d-flex">
